...
static inline void writeFilteredOutput(int16_t *dest, uint32_t index, float filterOutput) {
...
static void filter(int16_t *source, int16_t *dest, uint32_t sampleRateDivider, uint32_t size) {
    ...
    for (uint32_t i = 0; i < size; i += sampleRateDivider) {
        ...
        writeFilteredOutput(dest, index, filterOutput);
...
void DigitalFilter_filter(int16_t *source, int16_t *dest, uint32_t sampleRateDivider, uint32_t size) {
